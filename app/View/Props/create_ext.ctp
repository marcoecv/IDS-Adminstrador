...
echo $this->Html->script('props/create_ext');
?>
    ...
    <form id="propsfrm" action="#" role="form" class="form-inline" method="post">
        <div class="left">
            ...
            <div>
                ...
                <input type="text" name="prop_name" size="43" id="prop_name"/>
            </div>
            <span class="separator"></span>
            ...
            <div class="input-group date form_time col-md-5" id="wagertime_prop" data-date="" data-date-format="hh:ii" data-link-field="dtp_input3" data-link-format="hh:ii">
                <input class="form-control" size="16" type="text" value="" id="input_wagertime_prop"readonly required>
                <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
            </div>
        </div>
        <div class="right">
            <div>
                ...
                <select name="correlational_id" id="correlational_id" disabled class="form-control inlineDiv3" style="width: 360px">
                    <option value=""></option>
                </select>
            </div>
            <span class="separator"></span>
            ...
            <div class="inline-form">
                ...
                <textarea class="form-control" rows=3 cols="48"name="comments" id="comments"></textarea>
            </div>
        </div>
